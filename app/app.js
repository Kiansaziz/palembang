var app = angular.module('app', ['ngRoute', 'toastr','angularUtils.directives.dirPagination', 'angular.morris', 'underscore', 'ngSanitize', 'ngCsv']);
    ...
    function($routeProvider) {
      ...
      .when("/user/:idUser", {
       ...
       .when("/dinas", {
          templateUrl : "dinas.html",
          controller  : "dinasController",
          activetab   : 'dinas'
      })
      .when("/dinas/:id", {
          templateUrl : "dinas-detail.html",
          controller  : "dinasDetailController",
          activetab   : 'dinas'
      })
      .when("/jenis",{
        templateUrl   : "jenis.html",
        controller    : "jenisController",
        activetab     : 'jenis'
      })
      .when("/jenis/:id" ,{
        templateUrl   : "jenis-detail.html",
      ...
      .when("/project-history/:id",{
        templateUrl   : "project-history.html",
        controller    : "projectHistoryController",
        activetab     : 'project-history'
      })
      .when("/project-history-lihat/:id",{
        templateUrl   : "project-history-lihat.html",
        controller    : "projectLihatHistory",
        activetab     : 'project-history'
      })
      .when("/info", {
